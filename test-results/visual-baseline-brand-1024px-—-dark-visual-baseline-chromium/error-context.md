...
- Name: visual-baseline.spec.js >> brand @ 1024px — dark >> visual baseline
- Location: tests\visual-baseline.spec.js:37:13

# Error details

```
Error: UNKNOWN: unknown error, open 'D:\My Stuff\Git\CometGit\portfoliowebsite\tests\baselines\brand_1024_dark.png'
```
